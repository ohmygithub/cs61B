...
public class SList {
  ...
  public static void main (String[] args) {
    // Fill in your solution for Part I here.
	  SListNode node1 = new SListNode(12, null);
	  SListNode node2 = new SListNode(9, node1);
	  SListNode node3 = new SListNode(6, node2);
	  SList slist = new SList();
	  slist.head = node3;
	  slist.size = 3;
	  slist.tail = slist.getTail();
