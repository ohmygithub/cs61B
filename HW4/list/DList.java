...
public class DList {
  ...
  public DList() {
    //  Your solution here.
	  DListNode node = newNode(new Integer(3), head, head);
	  head = node;
	  head.prev = head;
	  head.next = head;
	  size = 0;
  ...
  public void insertFront(Object item) {
    // Your solution here.
	  DListNode dlist = newNode(item, head, head.next);
  ...
  public void insertBack(Object item) {
    // Your solution here.
	  DListNode dlist = newNode(item, head.prev,head);
	  head.prev.next = dlist;
	  head.prev = dlist;
	  size ++;
  }
  ...
  public void insertAfter(Object item, DListNode node) {
    // Your solution here.
	  ...
	  DListNode dlistnode = newNode(item, node, node.next);
	  node.next.prev = dlistnode;
	  node.next = dlistnode;
	  size ++;
  }
  ...
  public void insertBefore(Object item, DListNode node) {
    // Your solution here.
	  ...
	  DListNode dlistnode = newNode(item, node.prev, node);
	  node.prev.next = dlistnode;
	  node.prev = dlistnode;
	  size ++;
  }
...
//	    System.out.println("the last item in DList is " + l.back().item);
//	    
//	    System.out.println("\n\n### TESTING insertBack ###\nList with 8 and 9 is "
//	                       + l);
//	    
//	    l.insertBack(2);
//	    System.out.println("\nList with 2 in the back is " + l);
...
//	    System.out.println("after removing head.next: " + l);
//	    l.remove(l.head.next.next);
//	    System.out.println("after removing head.next.next: " + l);
//	    l.remove(l.head.prev);
//	    System.out.println("after removing head.prev: " + l);
//  }
}