...
//    // Your solution here.
//	  DListNode current = (DListNode) s.list.front();
//	  while(current != s.head){
//		  this.insert((Comparable)current.item());
...
//    // Your solution here.
//	  ListNode curS = (DListNode) s.list.front();
//	  ListNode curThis = (DListNode) list.front();
//	  mergesort(list);
//	  while(curThis != head){
//		  while(curS != s.head){
//			  if(curS.item() != curThis.item()){
//				  curS = curS.next();
//				  continue;
//			  }
//			  break;
...
//  }
  ...
  public String toString(){
    // Replace the following line with your solution.
	    String result = "{  ";
	    if(this.cardinality() != 0){
	    	DListNode current = (DListNode) list.front();
